...
<div class="drivers-form">
    ...
    <div class="row">
        <div class="col-md-6"><?= $form->field($model, 'drivers_passport')->textInput(['maxlength' => true]) ?></div> 
        <div class="col-md-6"> <?= $form->field($model, 'drivers_licence')->textInput(['maxlength' => true]) ?></div>
    </div>
    <div class="row">
        <div class=" col-md-12">
            <?=
