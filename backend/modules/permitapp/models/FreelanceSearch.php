...
/**
 * FreelanceSearch represents the model behind the search form about `backend\modules\permitapp\models\Freelance`.
 */
class FreelanceSearch extends Freelance
{
    ...
    {
        return [
            [['id', 'gender', 'age', 'province', 'country', 'start_province', 'start_border_point', 'target_province', 'out_province', 'out_border_point', 'request_chanel', 'created_at', 'updated_at', 'cretaed_by', 'updated_by', 'approve_status', 'approve_by', 'approve_comment', 'dlt_office', 'dlt_br', 'brands', 'seat', 'car_type', 'owner_type', 'operate_by'], 'integer'],
